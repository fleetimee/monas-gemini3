...
export function Visit() {
  ...
  return (
    <section ref={containerRef} id="visit" className="min-h-screen bg-black relative flex flex-col md:flex-row overflow-hidden">
      ...
      >
        <span className="font-serif text-[20vw] font-bold text-white leading-none">LOCATION</span>
      </motion.div>

      {/* Info Side */}
      <div className="w-full md:w-1/2 p-6 md:p-24 flex flex-col justify-center border-r border-white/5 z-10 bg-black/80 backdrop-blur-sm">
        <motion.div
        ...
        >
          ...
          <h3 className="font-serif text-4xl md:text-6xl text-white mb-16 leading-tight">
            Experience <br />
          ...
          <div className="space-y-12">
            ...
            >
              ...
              <div className="flex justify-between items-end">
                ...
                <Link href="#visit" className="flex items-center space-x-2 text-primary text-sm uppercase tracking-widest hover:text-white transition-colors">
                  <span>Book Now</span>
                  <ArrowRight size={16} />
                </Link>
              </div>
      ...
      {/* Map Side */}
      <div className="w-full md:w-1/2 min-h-[40vh] md:min-h-screen relative grayscale hover:grayscale-0 transition-all duration-1000 z-10">
         <MonasMap />
